...
export default function ThankYou() {
  return (
    <div className="flex h-[100dvh] w-full items-center justify-center bg-gray-100 dark:bg-gray-950 bg-[url('public/image/background.jpg')] bg-cover">
      <div className="space-y-4 text-center">
        ...
        <p className="text-lg text-white dark:text-gray-300">
            Thank you for your support and feedback. Your input helps us elevate our space exploration solutions to new
            heights.
          </p>
          <Link
